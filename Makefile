...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Dec 9 01:34:51 2017
...
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lminiupnpc /home/geertjan/git/NotEvilDime2/src/leveldb/libleveldb.a /home/geertjan/git/NotEvilDime2/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/geertjan/git/NotEvilDime2/src/leveldb/libleveldb.a; cd /home/geertjan/git/NotEvilDime2/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/geertjan/git/NotEvilDime2/src/leveldb/libleveldb.a: FORCE
	cd /home/geertjan/git/NotEvilDime2/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

build/build.h: FORCE
	cd /home/geertjan/git/NotEvilDime2; /bin/sh share/genbuild.sh build/build.h
