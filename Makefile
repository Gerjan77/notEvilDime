#############################################################################
# Makefile for building: notevildime-qt
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun Nov 26 05:05:35 2017
# Project:  notEvilDime-qt.pro
# Template: app
# Command: /usr/bin/qmake USEPNP=- -o Makefile notEvilDime-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_WEBKIT -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -D_FILE_OFFSET_BITS=64 -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lminiupnpc /home/geertjan/notEvilDime/notEvilDime-src/source/src/leveldb/libleveldb.a /home/geertjan/notEvilDime/notEvilDime-src/source/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: notEvilDime-qt.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USEPNP=- -o Makefile notEvilDime-qt.pro
...
/home/geertjan/notEvilDime/notEvilDime-src/source/src/leveldb/libleveldb.a: FORCE
	cd /home/geertjan/notEvilDime/notEvilDime-src/source/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

build/build.h: FORCE
	cd /home/geertjan/notEvilDime/notEvilDime-src/source; /bin/sh share/genbuild.sh build/build.h
...
src/qt/locale/bitcoin_ach.qm: src/qt/locale/bitcoin_ach.ts
	/usr/bin/lrelease src/qt/locale/bitcoin_ach.ts -qm src/qt/locale/bitcoin_ach.qm
