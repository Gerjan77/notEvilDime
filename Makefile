...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Nov 29 07:15:11 2017
# Project:  notEvilDime-qt.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.8/mkspecs/macx-g++42 CONFIG+=release -o Makefile notEvilDime-qt.pro
#############################################################################
...
CC            = gcc-4.2
CXX           = g++-4.2
DEFINES       = -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DMAC_OSX -DMSG_NOSIGNAL=0 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -O2 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.5 -pthread -Wall -W $(DEFINES)
CXXFLAGS      = -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.5 -pthread -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
INCPATH       = -I/usr/local/Qt4.8/mkspecs/macx-g++42 -I/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/usr/include/QtCore -I/Library/Frameworks/QtNetwork.framework/Versions/4/Headers -I/usr/include/QtNetwork -I/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/usr/include/QtGui -I/usr/include -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -I/opt/local/include -I/usr/local/Cellar/berkeley-db@4/4.8.30/include -I/usr/local/Cellar/openssl/1.0.2m/include -Ibuild -Ibuild -F/Library/Frameworks
LINK          = g++-4.2
LFLAGS        = -headerpad_max_install_names -fstack-protector-all -arch x86_64 -pthread -Xarch_x86_64 -mmacosx-version-min=10.5
...
Makefile: notEvilDime-qt.pro  /usr/local/Qt4.8/mkspecs/macx-g++42/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
		/usr/local/Qt4.8/mkspecs/common/mac.conf \
		/usr/local/Qt4.8/mkspecs/common/gcc-base.conf \
		/usr/local/Qt4.8/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Qt4.8/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-g++42 CONFIG+=release -o Makefile notEvilDime-qt.pro
...
/Users/geert-januijtdewilligen/Documents/GitHub/notEvilDime/src/leveldb/libleveldb.a: FORCE
	cd /Users/geert-januijtdewilligen/Documents/GitHub/notEvilDime/src/leveldb && CC=gcc-4.2 CXX=g++-4.2 $(MAKE) OPT="-pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a
...
build/macdockiconhandler.o: src/qt/macdockiconhandler.h \
	...
	gcc-4.2 -c $(QMAKE_COMP_QMAKE_OBJECTIVE_CFLAGS) $(DEFINES) $(INCPATH) src/qt/macdockiconhandler.mm -o build/macdockiconhandler.o

build/macnotificationhandler.o: src/qt/macnotificationhandler.h \
		src/qt/macnotificationhandler.mm
	gcc-4.2 -c $(QMAKE_COMP_QMAKE_OBJECTIVE_CFLAGS) $(DEFINES) $(INCPATH) src/qt/macnotificationhandler.mm -o build/macnotificationhandler.o
